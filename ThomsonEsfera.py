...
class Electron:
	...
	def cartessian(self):
		return [R*cos(self.azimuth)*sin(self.polar), R*sin(self.azimuth)*sin(self.polar), R*cos(self.polar)]
...
#ESFERA
def distancia(e1, e2):
	return sqrt(2*(R**2)*(1-(sin(e1.polar)*sin(e2.polar)*cos(e1.azimuth-e2.azimuth)+cos(e1.polar)*cos(e2.polar))))
